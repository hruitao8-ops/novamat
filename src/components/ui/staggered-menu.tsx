...
export const StaggeredMenu = ({
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const preLayers: HTMLElement[] = [];
      if (preContainer) {
        preLayers.push(...Array.from(preContainer.querySelectorAll('.sm-prelayer')) as HTMLElement[]);
      }
        ...
        {showLogo && (
          <div className="sm-logo" aria-label="Logo">
            {logoUrl ? (
              ...
              <span className="sm-logo-text">NovaMat AI</span>
            )}
          </div>
        )}
        <button
